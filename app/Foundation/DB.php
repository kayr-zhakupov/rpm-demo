...
class DB
{
  ...
  /**
   * Установка часового пояса в UTC при инициализации БД-подключения - вошло в привычку, чтобы не путаться
   * в последующих проектах и не разбираться, где какой пояс.
   * @return \PDO
   */
